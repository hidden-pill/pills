...
<body>
  ...
  <div class="modal" id="logIn">
    ...
    <form action="index.php" method="POST">
        <label for="identifier">Votre identifiant</label>
        <input id="identifier" name="identifier" placeholder="Pseudo ou email" type="text" />
        <label for="password">Mot de passe</label>
        <input id="password" name="password" placeholder="password" type="password" />
        <div class="loginCancel">
          <input id="submitLogin" class="btn" name="submitLogin" type="submit" value="Se connecter" />
          <input class="modal-close btn red" type="button" value="Annuler" />
        </div>
        <div class="register">
            <a class="btn black" href="<?= $path; ?>views/register.php">Créer un compte</a>
        </div>
    </form>
</div>
